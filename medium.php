                                ...
                                <div class="col-md-5">
                                    <div class="input-group mb-3">
                                        <select name="level" class="form-control">
                                            ...
                                            <option value="English" <?php if (isset($_GET['level']) && $_GET['level'] == "English") {
                                                                        echo "selected";
                                                                    } ?>> English</option>
                                            <option value="French" <?php if (isset($_GET['level']) && $_GET['level'] == "French") {
                                                                        echo "selected";
                                                                    } ?>> French</option>
                                            <option value="Hindi" <?php if (isset($_GET['level']) && $_GET['level'] == "German") {
                                                                        echo "selected";
                                                                    } ?>> Hindi</option>
                                        </select>
...
<section class="course" id="course">
    <div class="box-container">
        ...
        $s = "English";
        if (isset($_GET['level'])) {
            if ($_GET['level'] == "English") {
                $s = "English";
            } elseif ($_GET['level'] == "French") {
                $s = "French";
            } elseif ($_GET['level'] == "German") {
                $s = "German";
            }
        }
        $sql = "SELECT * FROM itcourses
                        WHERE itcourses.Medium LIKE '%{$s}%' ";
